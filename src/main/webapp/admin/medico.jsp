                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Acontinuacion se muestra una tabla con diferentes datos de los medicos que prestan el servicio en la EPS.</li>
                        </ol>
                        ...
                        <a href="guardarMedico.jsp" class="btn btn-primary mb-3">Agregar Nuevo</a>
                        <div class="row">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <table id="datatablesSimple">
                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                List<Medico> lista = (List) request.getSession().getAttribute("listaMedicos");

                                                if(lista != null){
                                                    for(Medico result : lista){  
                                            ...
                                            <tr>
                                                ...
                                                <td><%=result.getEspecialidad().getNombre()%></td>
                                                <td><%=result.getSede().getNombre()%></td>
                                                <td>
                                                    <div class="d-flex gap-3">
                                                    <form name="eliminar" action="/MedicoEliminarSv" method="POST" >
                                                    ...
                                                    <form name="editar" action="/MedicoEditarSv" method="GET">
